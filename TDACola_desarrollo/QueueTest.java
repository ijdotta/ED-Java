...
/**
 * Queue Test - Estructura de Datos (DCIC-UNS).
 * Define casos de pruebas a aplicar sobre el TDA Queue
...
public class QueueTest {
	...
	/*
	 * Retorna la clase tipo Queue a testear.
	 * Indique clase que implementa Queue<E> que desea testear.
	...
	public void size2(){
		...
		try{
			...
			fail("Al eliminar un elemento de una cola que no está vacía lanza la excepción EmptyQueueException");
		}
	}
	...
	public void isEmpty(){
		...
		try{
			...
			fail("Al eliminar un elemento de una cola con un único elemento lanza la excepción EmptyQueueException");
		}
	}
	
	/*_______________________TESTS METODO front()_____________________________*/ 
	@Test 
	public void front(){
		try {
		...
		try{
			...
			fail("Al ver el tope de una cola con elementos lanza la excepción EmptyQueueException");
		}
	}
	
	/*_______________________TESTS METODOS enqueue() y dequeue()_____________________________*/
	@Test
	public void enqueueDequeue(){
		...
		try{
			...
			fail("Al eliminar elementos de una cola que no está vacía lanza la excepción EmptyQueueException");
		}
