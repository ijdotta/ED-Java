...
/**
 * Stack Test - Estructura de Datos (DCIC-UNS).
 * Define casos de pruebas a aplicar sobre el TDA Stack<E>.
...
public class StackTest{
	...
	/*
	 * Retorna la clase tipo Stack a testear.
	 * Indique la clase que implementa Stack<E> que desea testear.
	 * Por ejemplo: ArrayStack<String> o LinkedStack<String>.
	 */
	private Stack<String> getStack(){
		return new Pila_arreglo<String>();
	}
	...
	public void size2(){
		...
		try{
			...
			fail("Al desapilar en una pila con elementos lanza la excepción EmptyStackException");
		}
	}
	...
	public void isEmpty(){
		...
		try{
			...
			fail("Al desapilar en una pila con un elemento lanza la excepción EmptyStackException");
		}
	}
	
	/*_______________________TESTS METODO top()_____________________________*/ 
	@Test
	public void top(){
		try {
		...
		try{
			...
			fail("Al ver el tope de una pila con elementos lanza la excepción EmptyStackException");
		}
	}
	
	/*_______________________TESTS METODO push() y pop()_____________________________*/
	@Test
	public void pushPop(){
		s.push(n1);
		s.push(n2);
		...
		try{
			...
			fail("Al desapilar en una pila vacía con elementos lanza la excepción EmptyStackException");
		}
