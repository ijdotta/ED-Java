...
/**
 * List Test - Estructura de Datos (DCIC-UNS).
 * Define casos de pruebas a aplicar sobre el TDA PositionList<E>.
...
public class ListTest {
	private PositionList<String> l;
	private String n1, n2, n3, n4, n5, n6;
	
	/*
	 * Retorna la clase tipo PositionList a testear.
	 * Indique la clase que implementa PositionList<E> que desea testear.
	 * Por ejemplo: LinkedList<String> o DoubleLinkedList<String>.
	 */
	private PositionList<String> getList() {
		return new Lista_doble_enlazada<String>();
	}
	...
	public void size() {
		...
		assertTrue("Tamaño de la lista justo después de ser creada != 0", l.size() == 0);
		
		// Caso_de_prueba: Lista con un único elemento.
		l.addLast(n1);
		assertTrue("Tamaño de la lista luego de insertar un elemento != 1", l.size() == 1);
		
		// Caso_de_prueba: Lista con varios elementos.
		l.addLast(n2);
		assertTrue("Tamaño de la lista luego de insertar dos elementos != 2", l.size() == 2);
		
		l.addLast(n3);
		assertTrue("Tamaño de la lista luego de insertar tres elementos != 3", l.size() == 3);
		
		try {
		
			l.remove(l.first());
			assertTrue("El tamaño de la lista luego de insertar 3 elementos y eliminar uno es != 2", l.size() == 2);
			l.remove(l.last());
			assertTrue("El tamaño de la lista luego de insertar 3 elementos y eliminar dos es != 1", l.size() == 1);
			
			l.remove(l.first());
			assertTrue("El tamaño de la lista luego de insertar 3 elementos y eliminar los tres es != 0", l.size() == 0);
	...
	public void isEmpty() {
		// Caso_de_prueba: Lista Vacía.
		assertTrue("La lista no está vacía justo después de ser creada", l.isEmpty());
		
		// Caso_de_prueba: Lista con un único elemento.
		l.addFirst(n1);
		assertFalse("La lista está vacía justo después de insertar un elemento", l.isEmpty());
		
		// Caso_de_prueba: Lista con varios elementos.
		for (int i = 0; i < 10; i++) {
			l.addFirst(n1);
			assertFalse("La lista está vacía justo después de insertar elementos", l.isEmpty());
		}
		...
		try {
			...
			for (int i = 0; i < 10; i++) {
				l.remove(l.first());
				assertFalse("La lista está vacía teniendo elementos", l.isEmpty());
			}
		...
		try {
			...
			l.remove(l.first());
			assertTrue( "La lista no está vacía luego de eliminar el único elemento que contenía", l.isEmpty());
	...
	/*_______________________TESTS METODO first()_____________________________ */
	...
	public void first() {
		...
		try{
			...
			// Caso_de_prueba: Lista con un único elemento.
			l.addFirst(n1);
			assertTrue( "first() no funciona correctamente para una lista de un elemento.", l.first().element() == n1);
			
			// Caso_de_prueba: Lista con varios elementos.
			l.addFirst(n2);
			assertTrue("first() no funciona correctamente para una lista de dos elemento.", l.first().element() == n2);
			
			l.addLast(n3);
			assertTrue("first() no funciona correctamente para una lista de tres elemento.", l.first().element() == n2);
		...
		try {
			...
			l.remove(l.first());
			assertTrue("first() no funciona correctamente para una lista de dos elemento.", l.first().element() == n1);
			
			// Caso_de_prueba: Lista con un único elemento.
			l.remove(l.first());
			assertTrue("first() no funciona correctamente para una lista de un elemento.", l.first().element() == n3);
		
		} catch (InvalidPositionException e2) {
			fail("InvalidPositionException al invocar remove() en el testeo del método first()");
	...
	/*_______________________TESTS METODO last()_____________________________ */
	...
	public void last() {
		...
		try{
			...
			// Caso_de_prueba: Lista con un único elemento.
			l.addFirst(n1);
			assertTrue("last() no funciona correctamente para una lista de un elemento.", l.last().element() == n1);
			
			// Caso_de_prueba: Lista con varios elementos.
			l.addLast(n2);
			assertTrue("last() no funciona correctamente para una lista de dos elemento.", l.last().element() == n2);
			
			l.addFirst(n3);
			assertTrue("last() no funciona correctamente para una lista de tres elemento.", l.last().element() == n2);
		
		}catch (EmptyListException e){ 
			fail("Al solicitar la última posición de una lista que no está vacía se lanza la excepción EmptyListException");
		}
		
		try {
	
			l.remove(l.last());
			assertTrue( "last() no funciona correctamente para una lista de dos elemento.", l.last().element() == n1);
			
			// Caso_de_prueba: Lista con un único elemento.
			l.remove(l.last());
			assertTrue("last() no funciona correctamente para una lista de un elemento.", l.last().element() == n3);
	...
	/*_______________________TESTS METODO next()_____________________________ */
	...
	public void next() {
		...
		try {
			...
			fail("Al solicitar la última posición de una lista que no está vacía lanza la excepción EmptyListException");
		}

		// Caso_de_prueba: Lista con varios elementos.
		try {
	
			assertTrue("next() no funciona correctamente.", l.next(cursor).element() == n2);
			
			cursor = l.next(cursor);
			assertTrue("next() no funciona correctamente.", l.next(cursor).element() == n3);
		...
		try {	
			...
			for (int i = 0; i < 999; i++) {
				assertTrue("next() no funciona correctamente.", cursor.element().equals(String.valueOf(i)));
				cursor = l.next(cursor);
			}
			...
			fail("Al solicitar la primer posición de la lista no debería lanzar la excepción EmptyListException");
		}
	...
	/*_______________________TESTS METODO prev()_____________________________ */
	...
	public void prev() {
		...
		try {
			...
			assertTrue("prev() no funciona correctamente.", l.prev(cursor).element() == n2);
			cursor = l.prev(cursor);
			assertTrue("prev() no funciona correctamente.", l.prev(cursor).element() == n1);
			cursor = l.prev(cursor);
		...
		try {
			...
			for (i = 999; i >= 0; i--) {
				assertTrue("prev no funciona correctamente", cursor.element().equals(String.valueOf(i)));
				cursor = l.prev(cursor);
				if (i == 0)
					fail("Al invocar prev() con una la primer posición de la lista no lanza la excepción BoundaryViolationException");
			}
	...
	/* _______________________TESTS METODO addFirst()_________________________ */
	...
	public void addFirst() {
		...
		try {
			...
			for (i = 999; i >= 0; i--) {
				assertTrue("addFirst() no funciona correctamente", cursor.element().equals(String.valueOf(i)));
				cursor = l.next(cursor);
				if (i == 0)
	...
	/*_______________________TESTS METODO addLast()___________________________ */
	...
	public void addLast() {
		...
		try {
			...
			for (i = 0; i <= 999; i++) {
				assertTrue("addLast() no funciona correctamente", cursor.element().equals(String.valueOf(i)));
				cursor = l.next(cursor);
				if (i == 999)
	...
	/* _______________________TESTS METODO addAfter()___________________________ */
	...
	public void addAfter() {
		...
		try {
			...
			fail("Al solicitar la primer o última posición de una lista que no está vacía lanza la excepción EmptyListException");
		}
		...
		try {
			...
			cursor = l.first();
			assertTrue("addAfter() no funciona correctamente", cursor.element() == n1);
			
			cursor = l.next(cursor); 
			assertTrue("addAfter() no funciona correctamente", cursor.element() == n2);
			
			cursor = l.next(cursor);
			assertTrue("addAfter() no funciona correctamente", cursor.element() == n3);
		...
		try {
			...
			cursor = l.next(cursor);
			assertTrue("AddAfter no funciona correctamente", cursor.element() == n4);
			
			cursor = l.next(cursor);
			assertTrue("AddAfter no funciona correctamente", cursor.element() == n2);
			
			cursor = l.next(cursor);
			assertTrue("AddAfter no funciona correctamente", cursor.element() == n5);
			
			cursor = l.next(cursor);
			assertTrue("AddAfter no funciona correctamente", cursor.element() == n3);
			
			cursor = l.next(cursor);
			assertTrue("AddAfter no funciona correctamente", cursor.element() == n6);
	...
	/* _______________________TESTS METODO addAfter()____________________________ */
	...
	public void addBefore() {
		...
		try {
			...
			cursor = l.first();
			assertTrue("addBefore() no funciona correctamente", cursor.element() == n2);
			
			cursor = l.next(cursor);
			assertTrue("addBefore() no funciona correctamente", cursor.element() == n3);
			
			cursor = l.next(cursor);
			assertTrue("addBefore() no funciona correctamente", cursor.element() == n1);
		...
		try {
			...
			fail("Al solicitar la última y primer posición de una lista que no está vacía lanza la excepción EmptyListException");
		}
		...
		try {
			...
			cursor = l.first();
			assertTrue("addBefore no funciona correctamente", cursor.element() == n4);
			cursor = l.next(cursor); 
			
			assertTrue("addBefore no funciona correctamente", cursor.element() == n2);
			cursor = l.next(cursor);
			
			assertTrue("addBefore no funciona correctamente", cursor.element() == n5);
			cursor = l.next(cursor);
			
			assertTrue("addBefore no funciona correctamente", cursor.element() == n3);
			cursor = l.next(cursor);
			
			assertTrue("addBefore no funciona correctamente", cursor.element() == n6);
			cursor = l.next(cursor);
	...
	public void remove() {
		...
		try {    
			...
			// Caso de prueba: Elimino el primer elemento de una lista no vacía.
			l.remove(cursor);
			cursor = l.first();
		...
		try {
			...
			for (i = 2; i < 6; i++) {
				assertTrue("remove() no funciona correctamente", cursor.element().equals(String.valueOf(i)));
				cursor = l.next(cursor);
				if (i == 5)
		...
		try {
			...
			cursor = l.first();
			assertTrue("remove() no funciona correctamente", cursor.element().equals(String.valueOf(2)));
			
			cursor = l.next(cursor);
			assertTrue("remove() no funciona correctamente", cursor.element().equals(String.valueOf(4)));
	...
	/* _______________________TESTS METODO set()_____________________________ */
	...
	public void set() {
		...
		try {
			...
			assertTrue("set() no funciona correctamente", cursor.element().equals(n2));
		...
		try {
			...
			for (i = 1; i < 10000; i++) {
				...
				assertTrue("set() no funciona correctamente", el2.equals(String.valueOf(i)));
				assertTrue("set() no funciona correctamente", cursor.element().equals(String.valueOf(i + 10)));
				cursor = l.next(cursor);
				if (i == 9999)
		...
		try {
			cursor = l.first();
			for (i = 11; i < 10010; i++) {
				assertTrue("set() no funciona correctamente", cursor.element().equals(String.valueOf(i)));
				cursor = l.next(cursor);
				if (i == 10009)
					fail("Error_Debería lanzarse la excepción BoundaryViolationException al invocar next() con la última posición de la lista testeando el método set().");
			}
	...
	public void iterator() {
		...
		assertTrue("El iterador no funciona correctamente", it.next().equals(n1));
		assertTrue("El iterador debe estar vacío", it.hasNext() == false);
	...
	public void positions() {
		...
		it = l.positions().iterator();
		assertTrue("El iterador no debe estar vacío", it.hasNext() == true);
		assertTrue("El iterador no funciona correctamente", it.next().element().equals(n1));
		assertTrue("El iterador debe estar vacío", it.hasNext() == false);
