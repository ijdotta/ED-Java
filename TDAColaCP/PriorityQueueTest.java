...
/**
 * PriorityQueue Test - Estructura de Datos (DCIC-UNS).
 * Define casos de pruebas a aplicar sobre el TDA PriorityQueue<K,V>.
 * @author Estructuras de Datos, DCIC-UNS.
 * @version 1.0 - María Lujan Ganuza (2013-2018)
 * @see PriorityQueue<K,V>
 */
...
public class PriorityQueueTest {
	...
	private PriorityQueue<Integer, String> s;
	private String n1, n2, n3, n4, n5, n6;
	private Integer i1, i2, i3, i4, i5, i6;
	
	/*
	 * Retorna la clase tipo PriorityQueue a testear.
	 * Indique la clase que implementa PriorityQueue<K,V> que desea testear.
	 * Por ejemplo: ColaCP_con_arreglo<Integer,Integer> o ColaCP_con_heap<Integer,Integer>.
	 */
	private PriorityQueue<Integer, String> getPriorityQueue() {
		return new HeapPriorityQueue<Integer, String>(/* new Comparador<Integer>() */);
	}
